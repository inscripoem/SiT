...
class large_data_dist(VisionDataset):
    def __init__(
        ...
        self._trainval_dist_file = self._dist_folder / 'large_data_trainval.json'
        ...
        if is_pretrain:
            ...
            dist_index = self.get_dist(split_index, dist_file, ratio)
        else:
    ...
    def get_split(self, index, split):
        if not self._test_dist_file.exists():
            ...
            with open(self._trainval_dist_file, 'r') as f:
